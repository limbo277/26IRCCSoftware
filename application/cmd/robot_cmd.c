...
static Graysensor_Upload_Data_s
    Graysensor_Fetch_Data; // 从灰度传感器接收的反馈信息
...
PfsmHandler StartMode_PfsmHandler;
PfsmHandler ScanPlatform_PfsmHandler;
PfsmHandler Follow_PfsmHandler;
PfsmHandler AttackAvoid_PfsmHandler;
PfsmHandler ReloadPlatform_PfsmHandler;
